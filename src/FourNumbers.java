...
//    public static void main(String[] args) {
    ...
    public void numbers() {
        ...
        System.out.println("The computer has generate a unique 4 digit number.\n"
                + "You can try to guess the 4 digits number in 10 attempts.\n");
        ...
        while (maxTry > 0 && indexMatch != 4) {
            ...
            if (indexMatch == 4) {
                ...
                maxTry--;
                if (maxTry > 1) {
                    System.out.print("You have guess " + indexMatch + " correct number in correct position," +
                            " and " + match + " correct number in incorrect position. " + maxTry + " attempt remaining. ");
                } else if (maxTry == 1) {
                    System.out.print("You have guess " + indexMatch + " correct number in correct position," +
                            " and " + match + " correct number in incorrect position. Last attempt!. Good luck");
                } else {
                    System.out.println("Sorry, you failed to guess the number in 10 attempts.");
